...
import { useSendEmailStatusOrderMutation, useUpdateOrderCompleteMutation, useUpdateOrderDoneMutation } from "../../../api/order";


const OrderReceivedDetail = ({ data }: any) => {
    ...
    const [orderShip, { isLoading: shiping }] = useUpdateOrderCompleteMutation()
    ...
    return (
        <>
            ...
            <tr >
                ...
                <td>
                    <>
                        {shiping ? <Spin indicator={antIcon} /> : <Button onClick={HandleShip}>Hoàn Thành</Button>}
                    </>
                </td>
                <td>
...
export default OrderReceivedDetail