...
import { useSendEmailStatusOrderMutation, useUpdateOrderShipMutation } from "../../../api/order";
import { useAddActionMutation } from "../../../api/actions";


const OrderShipDetail = ({ data }: any) => {
    ...
    return (
        <>
            ...
            <tr >
                ...
                <td>
                    <>
                        {shiping ? <Spin indicator={antIcon} /> : <Button onClick={HandleShip}>Giao ngay</Button>}
                    </>
                </td>
                <td>
...
export default OrderShipDetail