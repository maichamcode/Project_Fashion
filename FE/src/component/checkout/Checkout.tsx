...
import { useCreate_vnpayMutation, useGetOneVnpayQuery } from "../../api/vnpay";
import useScrollToTopOnMount from "../../utils/useScrollToTopOnMount";
import CheckOutNoTokenDetail from "./CheckOutNoTokenDetail";
import CurrencyFormatter from "../../utils/FormatTotal";
const { Option } = Select;
import io from "socket.io-client";
import "../../component/checkout/styleVoucher.css";
import {
                ...
                <div style={{ width: "60%" }}>
                  ...
                  >
                    ...
                    <ul className="list">
                      ...
                      {cart?.data?.map((data: any) => (
                        <CheckOutDetail data={data} onTotal={HandleTotal} />
                      ))}
                    </ul>
