                            ...
                            <Form onFinish={onFinish} form={form}>
                                <div className="mb-3 row" style={{ marginTop: "15px" }} >
                                    ...
                                    <div className="col-sm-9">
                                        ...
                                        >
                                            <Input className="form-control" id="html5-text-input" style={{width:"400px"}} />
                                        </Form.Item>
                                    </div>
                                </div>
                                ...
                                <div className="mb-3 row" style={{ marginTop: "-15px" }}>
                                    ...
                                    <div className="col-sm-9">
                                        ...
                                        <Button
                                            ...
                                            style={{ marginLeft: "310px", height: "38px", width: "28%", marginTop: "-112px" }}
                                ...
                                <div className="mb-3 row" style={{ marginTop: "-15px" }}>
                                    ...
                                    <div style={{ marginLeft: "125px", width: "100%", marginTop: "-30px" }}>
                                        <Form.Item
                                            name="user_image"
                                            className="col-md-10"
