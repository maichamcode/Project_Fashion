...
import DataProductOutstan from "./dataProductOutstan";

const AllOutstanProduct = () => {
    ...
    const outstanProducts = products?.data?.filter((product: { outstan: null; }) => product?.outstan !== false && null);
                            ...
                            <div className="col-lg-9">
                                ...
                                {search == null ? (
                                    <DataProductOutstan
                                        ...
                                        minPrice={minPrice}
                                        maxPrice={maxPrice}
                                        productsort={outstanProducts} // Pass the sorted products here
                                    />
                                ) : (
                                    <SearchProduct
                                        dataSearch={search}
...
export default AllOutstanProduct;