...
import DetailOrderInUser from "../ListOrder/DetailOrderInUser"
...
const SearchOrder = () => {
    ...
    const { data: users } = useGetOneUserQuery(checkout?.data?.user_id)
console.log(users);
    ...
    return (
        <>
            ...
            <div className="container-fluid order-detail-section" style={{marginTop:50}}>
                <div className="container">
                            ...
                            <div className="card mb-4">
                                <div className="card-body">
                                    ...
                                    <table className="table table-borderless">
                                        <tbody>
                                            {checkout?.data?.product?.map((data: any, index: any) => <DetailOrderInUser key={index} data={data} />)}
                                        </tbody>
                                        <tfoot>
                                            <tr>
                                ...
                                <div className="card-body">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-6">
                                            ...
                                            <address>
                                                <strong>
                                                    {checkout?.data?.user_id ? `${users?.data?.user_lastname} ${users?.data?.user_firstname}` : `${checkoutnames?.name}`}
                                                </strong>
                                                <br />
                                                {checkout?.data?.user_id ? `${users?.data?.user_phone}` : `${checkoutnames?.phone}`}
                                                <br />
